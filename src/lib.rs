// src/lib.rs
/*
 * Core library for WebSocketGateway
 */
...
#[derive(Debug)]
pub struct WebSocketGatewayProcessor {
    verbose: bool,
    processed_count: usize,
}

impl WebSocketGatewayProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting WebSocketGateway processing");
    
    let mut processor = WebSocketGatewayProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = WebSocketGatewayProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = WebSocketGatewayProcessor::new(false);
